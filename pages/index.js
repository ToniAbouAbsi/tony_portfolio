      ...
      <main className=' bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40'>
        ...
        <section className='text-center py-10'>
          ...
          <p className='text-md py-2 pb-5 text-gray-800 dark:text-gray-200 '>
            ...
            don't hesitate to reach out. You can contact me via phone or email,
            as provided below.
          </p>
          ...
          <div className='flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
            ...
            >
              <a href='https://safeheart.netlify.app/' target='blank'>
                <Image className='rounded-lg object-cover' src={Project1} />
              </a>
            </div>
            <div
              className='basis-1/3 flex-1 m-auto
            ...
            >
              <a href='https://taacocktails.netlify.app' target='blank'>
                <Image className='rounded-lg object-cover' src={Project2} />
              </a>
            </div>
          </div>
        </section>
